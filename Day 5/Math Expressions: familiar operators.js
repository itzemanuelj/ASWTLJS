...
let largeNum = 10000 * 20000;

/// Assign to the variable timer the result of dividing 9 by the value represented by the variable qty. The variable num hasn't been declared beforehand.
timer = 2;
let timer = 9 / qty;
